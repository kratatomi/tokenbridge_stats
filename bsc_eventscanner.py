...
from web3.middleware import geth_poa_middleware #Mandatory for PoA chains like BSC
...
class EventScanner:
    ...
    def __init__(self, web3: Web3, contract: Contract, state: EventScannerState, events: List, filters: {},
        ...
        self.web3 = web3
        self.web3.middleware_onion.inject(geth_poa_middleware, layer=0) #Mandatory for PoA chains like BSC
        self.state = state
        self.events = events
...
if __name__ == "__main__":
    ...
    # https://bscscan.com/address/0x6658010f8eb89889e5fcec7178f87a219f076166
    BRIDGE_ADDRESS = "0x6658010f8Eb89889e5fcEc7178f87a219F076166"
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "BSC_tokenbridge_events.json"
        ...
        def reset(self):
            ...
            self.state = {
                "last_scanned_block": 11525804, #Block where the bridge was deployed
                "blocks": {},
            }
    ...
    def run():
        ...
        if len(sys.argv) < 2:
            print("Usage: bsc_eventscanner.py http://your-node-url")
            sys.exit(1)
