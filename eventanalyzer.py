...
ETH_bridge_tokens =  {"0x46520D0244bdEa36899a5b96bDFe10880575a91E": ["BTC",  18],  
"0x68E91EF42816efaDD23Ac94011b7bD00C25082aA": ["ETH",  18], 
"0x1a5b299991664a89a212bE0D54bBc79C4E565C58": ["AAVE",  18], 
"0x3743eC0673453E5009310C727Ba4eaF7b3a1cc04": ["BCH",  18], 
...
BSC_bridge_tokens = {
"0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c": ["BNB",  18], 
"0xC7cb02462E4F65C7f570C2E13b0B1FB8a2EFAA9c": ["BCH",  18], 
"0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82": ["CAKE",  18], 
"0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56": ["BUSD",  18], 
"0x5831C7823AbaF0A325627da7638ACcBe959e249B": ["BNB",  18], 
"0x3743eC0673453E5009310C727Ba4eaF7b3a1cc04": ["BCH",  18], 
...
def statistics(data,  token_list):
    ...
    total_cross_value = 0
    total_acceptedcrosstransfer_value = 0
            ...
            for tx in data["blocks"][block_number][txhash]: 
                if tx == "Cross":
                    ...
                    if token_list[token_address][0] in results["Cross"]:
                        ...
                        results["Cross"][token_list[token_address][0]]["Value"] = results["Cross"][token_list[token_address][0]]["Price"] *  results["Cross"][token_list[token_address][0]]["Amount"]
                        total_cross_value += results["Cross"][token_list[token_address][0]]["Value"]
                    else:
                        results["Cross"][token_list[token_address][0]] = {"Amount": [], "No. of txs": [],  "Price": [],  "Value": []}
                        results["Cross"][token_list[token_address][0]]["Amount"] = data["blocks"][block_number][txhash][tx]["amount"] * 10**-token_list[token_address][1]
                        results["Cross"][token_list[token_address][0]]["No. of txs"] = 1
                        results["Cross"][token_list[token_address][0]]["Price"] = token_price(token_list[token_address][0])
                        results["Cross"][token_list[token_address][0]]["Value"] = results["Cross"][token_list[token_address][0]]["Price"] *  results["Cross"][token_list[token_address][0]]["Amount"]
                        total_cross_value += results["Cross"][token_list[token_address][0]]["Value"]
                if tx == "AcceptedCrossTransfer":
                    ...
                    if token_list[token_address][0] in results["AcceptedCrossTransfer"]:
                        ...
                        results["AcceptedCrossTransfer"][token_list[token_address][0]]["Value"] = results["AcceptedCrossTransfer"][token_list[token_address][0]]["Price"] *  results["AcceptedCrossTransfer"][token_list[token_address][0]]["Amount"]
                        total_acceptedcrosstransfer_value += results["AcceptedCrossTransfer"][token_list[token_address][0]]["Value"]
                    else:
                        results["AcceptedCrossTransfer"][token_list[token_address][0]] = {"Amount": [], "No. of txs": [],  "Price": [],  "Value": []}
                        results["AcceptedCrossTransfer"][token_list[token_address][0]]["Amount"] = data["blocks"][block_number][txhash][tx]["amount"] * 10**-18
                        results["AcceptedCrossTransfer"][token_list[token_address][0]]["No. of txs"] = 1
                        results["AcceptedCrossTransfer"][token_list[token_address][0]]["Price"] = token_price(token_list[token_address][0])
                        results["AcceptedCrossTransfer"][token_list[token_address][0]]["Value"] = results["AcceptedCrossTransfer"][token_list[token_address][0]]["Price"] *  results["AcceptedCrossTransfer"][token_list[token_address][0]]["Amount"]
                        total_acceptedcrosstransfer_value += results["AcceptedCrossTransfer"][token_list[token_address][0]]["Value"]
                        
    print("These are the tokens moved from {} to SmartBCH:\n".format(token_list["foreign_chain"]))
    pprint.pprint(results["Cross"])
    print(f"Total value moved: {total_cross_value: .2f}")
    print("\n")
    print("These are the tokens moved from SmartBCH to {}:\n".format(token_list["foreign_chain"]))
    pprint.pprint(results["AcceptedCrossTransfer"])
    print(f"Total value moved: {total_acceptedcrosstransfer_value: .2f}")
    print("\n")

def token_price(token_name):
    API = "https://coincodex.com/api/coincodex/get_coin/"
    url = requests.get(API + token_name)
    data = url.json()
